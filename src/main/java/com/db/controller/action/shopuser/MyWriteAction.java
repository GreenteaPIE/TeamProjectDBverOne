...
public class MyWriteAction implements Action {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String url = "/shopuser/myWriteList.jsp";
		...
		List<FreeBoardVO> boardList = fbDao.getMyBoardList(page, limit, userid);
		...
		// List<BoardVO> boardList = bDao.selectAllBoards(); 여기서는 대신
		// bDao.getBoardList사용!
