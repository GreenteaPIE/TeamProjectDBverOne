					...
					<div class="col-lg-4 col-md-6 col-sm-12 pb-1">
						<div class="card product-item border-0 mb-4">
							<div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
								<a href="DBServlet?command=brand_Product_Detail&pName=${CateGoriesList.pName}&bname=${CateGoriesList.bName}"><img class="img-fluid w-100" style="height: 280px" src="images/${CateGoriesList.imgUrl}" alt=""> </a>
							</div>
