		...
		<form id="join" action="DBServlet?command=join" method="post" name="formm">
			<div class="form-group input-group fg-x700">
				...
				<div class="btn-group" date-toggle="buttons">
					<label class="btn btn-primary active"> <input type="radio" name="gender" autocomplete="off" value="1" checked>남자
					</label> <label class="btn btn-primary"> <input type="radio" name="gender" autocomplete="off" value="2" checked>여자
					</label>
			...
			<div class="form-group input-group fg-x700">
				...
				<input id="userid" name="userid" class="form-control" placeholder="Id 입력" type="text" size="12" required />
				<input id="reid" name="reid" class="form-control" placeholder="Id 입력" type="hidden" size="12" required />
			...
			<div class="form-group input-group fg-x700">
				...
				<input id="email" name="email" class="form-control" placeholder="Email 입력" type="email" required />
			</div>
			<!-- form-group// -->
			<div class="form-group input-group fg-x700">
				<div class="input-group-prepend">
			...
			<div class="form-group input-group fg-x700">
				...
				<input id="pass" name="pass" class="form-control" placeholder="비밀번호 입력" type="password" required>
				<input id="passCheck" name="passCheck" class="form-control" placeholder="비밀번호 확인" type="password" required>
			</div>
			<!-- form-group// -->
