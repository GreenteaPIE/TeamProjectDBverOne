		...
		<div class="col-lg-9 col-md-12">
			<div class="row pb-3">
				...
				<c:forEach var="AuctionList" items="${AuctionList }">
					<input type="hidden" name="endTime" value="${AuctionList.endTime }" id="endTime">
					<div class="col-lg-4 col-md-6 col-sm-12 pb-1" align="center">
						<div class="card product-item border-0 mb-4">
							<div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
								<a href="DBServlet?command=auction_detail&num=${AuctionList.num }&pName=${AuctionList.pName}"><img class="img-fluid w-100" style="height: 280px" src="images/${AuctionList.imgUrl}" alt=""> </a>
							</div>
