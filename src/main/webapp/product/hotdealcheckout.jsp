...
<body>
	...
	<!-- Checkout Start -->
	<form action="DBServlet" name="frm" id="frm">
		<input type="hidden" value="hotdeal_order_insert" name="command">
					...
					<div class="mb-4">
						...
						<div class="row">
							<div class="col-md-6 form-group">
								<label>이름</label>
								<input class="form-control" type="text" value="${loginUser.name }" readonly>
							</div>

							<div class="col-md-6 form-group">
								<label>E-mail</label>
								<input class="form-control" type="text" value="${loginUser.email }" readonly>
							</div>
							<div class="col-md-6 form-group">
								<label>전화번호</label>
								<input class="form-control" type="text" value="${loginUser.phone }" readonly>
							</div>
							<div class="col-md-6 form-group">
								<label>주소</label>
								<input class="form-control" type="text" value="${loginUser.address1 }" readonly>
							</div>
							<div class="col-md-6 form-group">
								<label>상세주소</label>
								<input class="form-control" type="text" value="${loginUser.address2 }" readonly>
							</div>

							<div class="col-md-6 form-group">
								<label>우편번호</label>
								<input class="form-control" type="text" value="${loginUser.zipcode }" readonly>
							</div>
				...
				<div class="col-lg-4">
					<div class="card border-secondary mb-5">
						...
						<div class="card-body">
							...
							<div class="d-flex justify-content-between">
								<p>${ProductList.pName}</p>
								<input id="pname" type="hidden" value="${ProductList.pName}">

								<input type="hidden" name="hnum" value="${ProductList.num}">
								<p>
									<fmt:setLocale value="ko_KR" />
									<fmt:formatNumber type="currency" value="${hotdealprice}" currencySymbol="₩" />
								</p>
							</div>
							<c:set var="subprice" value="${hotdealprice}" />
					...
					<div class="card border-secondary mb-5">
						<div class="card border-secondary mb-5">
							...
							<div class="card-footer border-secondary bg-transparent">
								<button class="btn btn-lg btn-block btn-primary font-weight-bold my-3 py-3" id="checkout-button-two">Place Order</button>
							</div>
						</div>
					</div>
				</div>
...
const placeOrderBtn = document.getElementById('checkout-button-two');
