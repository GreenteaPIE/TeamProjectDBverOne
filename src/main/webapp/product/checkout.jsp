...
<body>
	...
	<form action="DBServlet" name="frm" id="frm">
		<input type="hidden" value="order_insert" name="command">
					...
					<div class="mb-4">
						...
						<div class="row">
							<div class="col-md-6 form-group">
								<label>이름</label>
								<input class="form-control" type="text" name="name" value="${loginUser.name }" readonly>
							</div>

							<div class="col-md-6 form-group">
								<label>E-mail</label>
								<input class="form-control" type="text" name="email" value="${loginUser.email }" readonly>
							</div>
							<div class="col-md-6 form-group">
								<label>전화번호</label>
								<input class="form-control" type="text" name="phone" value="${loginUser.phone }" readonly>
							</div>
							<div class="col-md-6 form-group">
								<label>주소</label>
								<input class="form-control" type="text" name="address1" value="${loginUser.address1 }" readonly>
							</div>
							<div class="col-md-6 form-group">
								<label>상세주소</label>
								<input class="form-control" type="text" name="address2" value="${loginUser.address2 }" readonly>
							</div>

							<div class="col-md-6 form-group">
								<label>우편번호</label>
								<input class="form-control" type="text" name="zipcode" value="${loginUser.zipcode }" readonly>
							</div>
									...
									<c:if test="${cart.num == ProductList.num}">
										<div class="d-flex justify-content-between">
											...
											<p>
												...
												<fmt:formatNumber type="currency" value="${ProductList.price * cart.quantity}" currencySymbol="₩" />
											</p>
										</div>
										<c:set var="subprice" value="${subprice + ProductList.price * cart.quantity}" />
									</c:if>
								</c:forEach>
							</c:forEach>
